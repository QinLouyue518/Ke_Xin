...
![alt text](https://img.shields.io/badge/Platform-Flutter-02569B?logo=flutter)

![alt text](https://img.shields.io/badge/AI-DeepSeek--R1-blue?logo=openai)
...
前往 DeepSeek 官方 或 硅基流动 申请 API Key。
在 App「设置」->「AI 模型配置」中填入 Key 与对应的 Endpoint。
推荐使用 deepseek-reasoner (R1) 以获得最佳的思维链展示效果。
📜 开发者自述
...
🤝 贡献与反馈
欢迎提交 Issue 或 Pull Request。如果你也对“数字化第二大脑”感兴趣，欢迎联系我。
如果这个项目对你有启发，请给它一个 ⭐️ Star，这对我这个新人开发者意义重大！
🎨 预览 (Screenshots)
(此处建议放 3-4 张精选截图：星图、画像页、R1对话页、人生剧本页)
