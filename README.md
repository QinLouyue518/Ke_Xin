...
## 🎨 预览 (Screenshots)
> 建议放置 3-4 张精选截图：星图、画像页、R1对话页、人生剧本页
![Memory Galaxy](screenshots/galaxy.png)
![5D Persona](screenshots/persona.png)
![AI Companion](screenshots/companion.png)
![Life Chapters](screenshots/chapters.png)
